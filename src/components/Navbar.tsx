      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav id="desktop-nav" className="hidden lg:flex items-center gap-1">
            {navItems.map((item) => {
              if (item.subItems) {
                const isActive = currentPage === 'services' || isServiceActive;
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            >
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2.5 text-xs font-medium text-neutral-600 hover:text-neutral-950 dark:text-neutral-300 dark:hover:text-white hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all rounded-full border border-neutral-200/50 dark:border-neutral-800 cursor-pointer"
