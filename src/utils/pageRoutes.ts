...
export const PAGE_TO_PATH: Record<Exclude<PageId, 'not-found' | 'insights-detail' | 'work-detail'>, string> = {
  ...
  work: '/work',
  process: '/process',
  'website-design-surat': '/website-design-surat',
  'website-development-surat': '/website-development-surat',
  'seo-agency-surat': '/seo-agency-surat',
  'website-design-for-manufacturers': '/website-design-for-manufacturers',
  'ca-firm-website-design': '/ca-firm-website-design',
  'professional-services-websites': '/professional-services-websites',
  insights: '/insights',
  contact: '/contact',
  sitemap: '/sitemap',
  privacy: '/privacy',
