...
import { Phone, Mail, Clock, Linkedin, Instagram, ArrowUpRight } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <button onClick={() => handleLinkClick('why-choose-us')} className="hover:text-neutral-900 dark:hover:text-white transition-colors text-left">
                  Why Choose Us
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('portfolio')} className="hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2 text-left">
                  Portfolio
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('testimonials')} className="hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2 text-left">
                  Testimonials
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('insights')} className="hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2 text-left">
                  Insights <span className="text-[10px] bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-500 dark:text-neutral-400 px-1.5 py-0.5 rounded">Soon</span>
                </button>
              </li>
              <li>
                <button onClick={() => handleLinkClick('sitemap')} className="hover:text-neutral-900 dark:hover:text-white transition-colors flex items-center gap-2 text-left">
                  Sitemap
                </button>
              </li>
            </ul>
        ...
        <div className="border-t border-neutral-200 dark:border-neutral-800/80 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
          ...
          <div className="flex gap-6">
            <a href="https://www.magolabs.in" className="hover:text-neutral-900 dark:hover:text-white transition-colors">
              www.magolabs.in
            </a>
