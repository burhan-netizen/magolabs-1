        ...
        >
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <motion.button
              ...
              animate={{
                boxShadow: [
                  "0 10px 15px -3px rgba(37, 99, 235, 0.2), 0 0 0 0 rgba(37, 99, 235, 0.6)",
                  "0 10px 15px -3px rgba(37, 99, 235, 0.2), 0 0 0 10px rgba(37, 99, 235, 0)",
                ],
              }}
              transition={{
                duration: 2,
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-blue-600 px-8 py-4 text-base font-bold text-white hover:bg-blue-500 transition-all cursor-pointer"
            >
